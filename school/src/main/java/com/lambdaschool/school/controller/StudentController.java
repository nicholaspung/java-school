...
public class StudentController
{
    ...
    {
        logger.info(request.getMethod() + " " + request.getRequestURI() + " accessed with request.body {" + newStudent.getStudname() + "}");
    ...
    public ResponseEntity<?> updateStudent(
            ...
            @PathVariable
                    long Studentid, HttpServletRequest request)
    {
        logger.info(request.getMethod() + " " + request.getRequestURI() + " accessed with request.body {" + updateStudent.getStudname() + "}");
